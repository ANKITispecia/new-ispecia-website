...
>
  ...
  <div className="col-md-6">
    <ul className="single-list-inner style-check style-heading mb-3">
      <li style={{ display: "flex", alignItems: "center", gap: "10px" }}>
        <FaCheckCircle />
        <strong>Collaboration</strong>: Working together as a team to achieve shared goals.
      </li>
      <li style={{ display: "flex", alignItems: "center", gap: "10px" }}>
        <FaCheckCircle />
        <strong>Excellence</strong>: We strive for excellence in every project we undertake.
      </li>
      <li style={{ display: "flex", alignItems: "center", gap: "10px" }}>
        <FaCheckCircle />
        <strong>Integrity</strong>: We maintain transparency, honesty, and trust in everything we do.
      </li>
      <li style={{ display: "flex", gap: "10px" }}>
        <FaCheckCircle />
        <strong>Innovation</strong>: We believe in using the latest technologies to solve tomorrow's
        problems.
      </li>
    </ul>
  </div>
