...
const CounterAreaOne = () => {
  return (
    <>
      {/* counter area start */}
      <div
        className='counter-area bg-relative bg-cover pd-top-110 pd-bottom-100 text-center'
          ...
          <div className='row'>
                    ...
                    {({ isVisible }) =>
                      isVisible && (
                        <span className='counter'>
                          <CountUp duration={1} delay={0} start={0} end={330} />{" "}
                          +
                        </span>
                      )
                    }
            ...
            >
              <div className='single-counter-inner'>
                ...
                <h2 className='text-white mt-4 mb-2'>
                  <TrackVisibility once>
                    {({ isVisible }) =>
                      isVisible && (
                        <span className='counter'>
                          <CountUp duration={3} delay={0} start={0} end={25} />{" "}
                          +
                        </span>
                      )
                    }
                ...
                <p className='text-white'>Team advisors</p>
              </div>
            </div>
            <div
              className='col-lg-3 col-sm-6 '
            ...
            >
              <div className='single-counter-inner'>
                ...
                <p className='text-white'>Glorius Years</p>
              </div>
            </div>
          </div>
        </div>
